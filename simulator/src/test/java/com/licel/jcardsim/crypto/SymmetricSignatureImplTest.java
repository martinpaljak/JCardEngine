...
public class SymmetricSignatureImplTest extends SimulatorCoreTest {
     ...
     * and etalon data
     */
    private void testSignVerify(SymmetricKeyImpl desKey, String msg8, String msg15,
     ...
     */
    private void testEngineSignVerify(Signature engine, Key key, byte[] iv, byte[] msg, byte[] macEtalon) {
        // sign
        if (iv == null) {
