...
public class AsymmetricSignatureImplTest extends SimulatorCoreTest {
    ...
    static final String[] RSA_SIGNATURES = new String[] {
            // ALG_RSA_SHA_ISO9796
    ...
    static final String RSA_2048_MODULUS = "";
    ...
    public void testVerifyRSA() {
        ...
        testEngineVerify(signature, publicKey, Hex.decode(MESSAGE), Hex.decode(RSA_SIGNATURES[0]), (short) 0);

        signature = Signature.getInstance(Signature.ALG_RSA_SHA_PKCS1, false);
        testEngineVerify(signature, publicKey, Hex.decode(MESSAGE), Hex.decode(RSA_SIGNATURES[1]), (short) 0);

        signature = Signature.getInstance(Signature.ALG_RSA_SHA_PKCS1, false);
        testEngineVerify(signature, publicKey2048, new byte[24], Hex.decode(RSA_2048_SIGNATURE), (short) 0);

        signature = Signature.getInstance(Signature.ALG_RSA_MD5_PKCS1, false);
        testEngineVerify(signature, publicKey, Hex.decode(MESSAGE), Hex.decode(RSA_SIGNATURES[2]), (short) 0);
    }
     ...
     */
    @SuppressWarnings("deprecation") // ALG_PSEUDO_RANDOM
    private void testSelfPrecompSignVerify(byte keyAlg, short keySize, byte signAlg, byte digestAlgo) {
        // generate keys
        KeyPair kp = new KeyPair(keyAlg, keySize);
        kp.genKeyPair();
        PrivateKey privateKey = kp.getPrivate();
