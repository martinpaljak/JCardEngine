...
public class SymmetricCipherImplTest {
     ...
     * and DES cipher
     */
    private void testDoFinalDES(SymmetricKeyImpl desKey, String msg8, String msg15,
     ...
     */
    private void testAESMode(short keyLen, byte mode, String[] testData) {
     ...
     */
    private void testEngineDoFinal(Cipher engine, Key key, byte[] iv, byte[] msg, byte[] encryptedEtalonMsg) {
    ...
    private void testKOREAN_SEED(String[] seedTestData, byte algorithm) {
